...
class _SearchFlightsScreenState extends State<SearchFlightsScreen>
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF0B5ED7).withOpacity(.06),
              blurRadius: 24,
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFF0B5ED7), Color(0xFF38BDF8)],
                  ),
                ),
              ),
              Padding(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          ...
                          elevation: 0,
                          shadowColor: const Color(0xFF0B5ED7).withOpacity(.4),
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              height: 40,
              decoration: BoxDecoration(
                color: canSwap ? const Color(0xFFEAF2FF) : const Color(0xFFF5F7FA),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: canSwap ? const Color(0xFF0B5ED7).withOpacity(.2) : const Color(0xFFE0E6EF),
                ),
              ),
              child: Icon(
                Icons.swap_vert_rounded,
                size: 20,
                color: canSwap ? const Color(0xFF0B5ED7) : const Color(0xFF98A2B3),
              ),
            ),
          ),
        ),
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          height: 32,
          decoration: BoxDecoration(
            color: enabled ? const Color(0xFFEAF2FF) : const Color(0xFFF5F7FA),
            borderRadius: BorderRadius.circular(10),
          ),
          child: Icon(
            icon,
            size: 18,
            color: enabled ? const Color(0xFF0B5ED7) : const Color(0xFF98A2B3),
          ),
        ),
      ),
    );
  ...
  Widget _buildResults() {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          const Icon(Icons.auto_awesome_rounded, color: Color(0xFF0B5ED7), size: 20),
  ...
  Widget _buildCompactDealCard(FlightDeal deal) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 12),
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(destination?.name ?? deal.destinationAirportCode, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w700)),
          Text('${deal.airline} · ${_formatDate(deal.departureDate)}', style: const TextStyle(color: Color(0xFF667085), fontSize: 12)),
        ])),
  ...
  Widget _buildDealCard(FlightDeal deal) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Expanded(child: Text('${deal.currency} ${(deal.price * _passengers).toStringAsFixed(0)}', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFF0B5ED7)))),
          Container(
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 4),
          Text('Crea una alerta y te avisamos cuando encontremos una baja de precio.', style: TextStyle(color: Color(0xFFDCEBFF), fontSize: 12, height: 1.35)),
        ])),
        const SizedBox(width: 8),
